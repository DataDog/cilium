...
NODE_CONFIG(__u8, policy_deny_response_enabled, "Enable ICMP responses for policy-denied traffic")
#define POLICY_DENY_RESPONSE CONFIG(policy_deny_response_enabled) /* Backwards compatibility */
