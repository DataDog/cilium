...
MODIFIERS="GOEXPERIMENT=boringcrypto CGO_ENABLED=1 EXTRA_GO_BUILD_LDFLAGS='-linkmode external -extldflags -static -extldflags --enable-static-nss'"
# Construct valid --build-args arguments from the DOCKER_BUILD_ARGS variable
BUILD_ARGS="--build-arg MODIFIERS=${MODIFIERS}"
IFS=$'\n'
