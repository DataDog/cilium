...
printf -v BUILD_ARGS " --build-arg MODIFIERS=\"GOEXPERIMENT=boringcrypto CGO_ENABLED=1 EXTRA_GO_BUILD_LDFLAGS='-linkmode external -extldflags -static -extldflags --enable-static-nss'\""
IFS=$'\n'
