...
BUILD_ARGS="--build-arg MODIFIERS=BORINGCRYPTO=1 --build-arg DD_GIT_REPOSITORY_URL=https://github.com/DataDog/cilium.git --build-arg DD_GIT_COMMIT_SHA=$(git rev-parse HEAD)"
