...
```
  ...
  -h, --help                                                      help for cilium-agent
      ...
      --neighbor-netlink-buffer-size int                          Size (in bytes) of the netlink socket receive buffer used to subscribe to neighbor updates; a larger buffer reduces the chance of ENOBUFS errors and subscription restarts under high neighbor churn (default 4194304)
