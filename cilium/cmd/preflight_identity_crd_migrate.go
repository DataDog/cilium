...
func initKVStore(ctx context.Context) (kvstoreBackend allocator.Backend) {
	...
	kvstoreBackend, err := kvstoreallocator.NewKVStoreBackend(kvstoreallocator.KVStoreBackendConfiguration{BasePath: cache.IdentitiesPath, Suffix: idPath, Typ: cache.GlobalIdentity{}, Backend: kvstore.Client()})
	if err != nil {
