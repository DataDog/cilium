...
func NewMetricsExtractor(logger *logrus.Entry, tenantID string, subscriptionID string, resourceType string, registry metrics.RegisterGatherer) *MetricsExtractor {
