...
func NewClient(cloudName, subscriptionID, resourceGroup, userAssignedIdentityID string, metrics MetricsAPI, rateLimit float64, burst int, usePrimary bool) (*Client, error) {
	...
	//TODO: figure out how to set the clients's user agent to userAgent through the armClientOptions

	//TODO: based on cloudName, pick cloud.AzureChina, cloud.AzureGovernment or cloud.AzurePublic
	// like azure.EnvironmentFromName(cloudName) does it
