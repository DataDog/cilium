...
func NewClient(cloudName, subscriptionID, resourceGroup, userAssignedIdentityID string, metrics MetricsAPI, rateLimit float64, burst int, usePrimary bool) (*Client, error) {
	...
	case azure.PublicCloud.Name:
		clientOptions.ClientOptions.Cloud = cloud.AzurePublic
	case azure.USGovernmentCloud.Name:
		clientOptions.ClientOptions.Cloud = cloud.AzureGovernment
	case azure.ChinaCloud.Name:
		clientOptions.ClientOptions.Cloud = cloud.AzureChina
	default:
