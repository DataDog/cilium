...
// TestAzureInterfaceDeepEqualIgnoresUnexportedFields verifies DeepEqual ignores
// the unexported json:"-" fields, so an in-memory interface compares equal to an
// apiserver copy where they are unset.
