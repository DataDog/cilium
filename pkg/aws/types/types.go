...
type ENISpec struct {
	...
	// Cilium attaches to this node. It accepts "default", "auto" or a positive
	// number of queues. "default", which is the value the agent writes when
	// nothing is configured, leaves the number of queues to AWS.
	//
	...
	//
	// +kubebuilder:validation:Pattern=`^(default|auto|[1-9][0-9]*)$`
	// +kubebuilder:validation:Optional
