		...
		for _, reservation := range output.Reservations {
			for _, instance := range reservation.Instances {
				for _, instanceENI := range instance.NetworkInterfaces {
					...
					result = append(result, ConvertInstanceNetworkInterfaceToNetworkInterface(instanceENI))
...
func ConvertInstanceNetworkInterfaceToNetworkInterface(eni ec2_types.InstanceNetworkInterface) ec2_types.NetworkInterface {
