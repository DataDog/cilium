...
func TestMock(t *testing.T) {
	...
	api := NewAPI([]*ipamTypes.Subnet{&subnet1}, []*ipamTypes.VirtualNetwork{{ID: "v-1"}}, []*types.SecurityGroup{{ID: "sg-1"}})
...
func TestSetMockError(t *testing.T) {
	...
	err = api.AssignPrivateIpAddresses(context.TODO(), "e-1", 10, netip.MustParsePrefix("10.0.0.0/24"))
	require.Equal(t, mockError, err)
