...
func TestGet(t *testing.T) {
	...
	newLimitsGetter, err := NewLimitsGetter(api, testTriggerMinInterval, testEC2apiTimeout, testEC2apiRetryCount)
...
func TestInitEC2APIUpdateTrigger(t *testing.T) {
	...
	limitsGetter, err := NewLimitsGetter(api, testTriggerMinInterval, testEC2apiTimeout, testEC2apiRetryCount)
