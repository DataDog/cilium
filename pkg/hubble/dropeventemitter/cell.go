...
func newDropEventEmitter(p params) FlowProcessor {
	...
	flowProcessor := new(p.Logger, p.Config.K8sDropEventsInterval, p.Config.K8sDropEventsReasons, p.Config.EnableK8sDropEventsExtended, p.Clientset, p.K8sWatcher, p.EndpointManager)
