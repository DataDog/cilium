...
func TestGetPolicyRulesFromEndpoint(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			rules, revision, _ := getPolicyRulesFromEndpoint(tt.flow.TrafficDirection, fakeEndpoint)
...
func (e *fakeEndpoint) GetRealizedL4PolicyModel() (*models.L4Policy, uint64, error) {
